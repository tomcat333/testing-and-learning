...
```
    ...
    array([[ 0.10040991,  0.91127074, -0.16607709],
...
```
    ...
    c:\users\dell\appdata\local\programs\python\python36\lib\site-packages\ipykernel_launcher.py:1: DeprecationWarning: 
